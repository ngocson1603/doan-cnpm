...
namespace GUI.XuLy
{
    public class ExcelExportBaoHanh
    {
        #region ---- Constants ----
        ...
        public const string T_BieuMau = "BieuMauBaoHanh";
        ...
        private MemoryStream GetTemplateStream(string viewName)
        {
            ...
            switch (viewName)
            {
                ...
                case T_BieuMau:
                    ...
                    arrByte = File.ReadAllBytes("BieuMauBaoHanh.xlsx").ToArray();
                    break;
        ...
        public bool ExportKhoa(List<View_BieuMauBH> dataSource, ref string fileName, bool isPrintPreview)
        {
            // Check if data is null
            ...
            return OutSimpleReport(dataSource, replacer, "BieuMauBaoHanh", isPrintPreview, ref fileName);
        }
