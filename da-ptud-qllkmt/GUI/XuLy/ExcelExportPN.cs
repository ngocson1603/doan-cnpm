...
namespace GUI.XuLy
{
    public class ExcelExportPN
    {
        ...
        public const string T_BieuMau = "BieuMauNhapHang";
        ...
        private void BuildReplacerCurrentDate(ref Dictionary<string, string> pReplacer)
        {
            if (pReplacer != null)
            {
                ...
                pReplacer.Add("%TenNguoiLap", frmNhapLinhKien.tennv);

               
                pReplacer.Add("%MaPhieuNhap", string.Format("{0}", frmNhapLinhKien.mapn));
                pReplacer.Add("%NhaCungCap", string.Format("{0}", frmNhapLinhKien.npp));
                pReplacer.Add("%TongTien", string.Format("{0}", frmNhapLinhKien.tongtien));
        ...
        private MemoryStream GetTemplateStream(string viewName)
        {
            ...
            switch (viewName)
            {
                ...
                case T_BieuMau:
                    ...
                    arrByte = File.ReadAllBytes("BieuMauNhapHang.xlsx").ToArray();
                    break;
        ...
        public bool ExportKhoa(List<View_BieuMauNhapHang> dataSource, ref string fileName, bool isPrintPreview)
        {
            // Check if data is null
            ...
            return OutSimpleReport(dataSource, replacer, "BieuMauNhapHang", isPrintPreview, ref fileName);
        }
